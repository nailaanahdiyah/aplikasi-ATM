...
atm = User(id) #membuat var class User di file user.py (instance object)
...
while True:
    ...
    #verifikasi pin
    while(id != int(atm.cekPin()) and percobaan < 3): #jika id tidak sama dengan Pin yang disiapkan dan trial masih kurang dari 3
        id = int(input('PIN salah. Silahkan masukkan kembali: '))
        percobaan += 1
        if percobaan == 3:
            print('\nError. Silahkan ambil kartu dan coba kembali')
            exit()
    while True:
            ...
            #cek saldo
            if pilih == 1:
                print('Saldo pada ATM anda sebesar: Rp.' + str(atm.cekSaldo())) #memanggil method cekBalance yg terdapat pada class Customer
            ...
            #debet
                ...
                if verifikasi == 1:
                    print('Saldo awal: Rp. ' +str(atm.cekSaldo()))
                else:
                    break
                ...
                if nominal < atm.cekSaldo():
                    ...
                    print('\nSaldo saat ini sebesar: Rp.' + str(atm.cekSaldo()) +'\n')
                else:
            ...
            #simpan
                ...
                if verifikasi == 1:
                    ...
                    print('Berhasil')
                    print('Saldo anda saat ini sebesar: ' +str(atm.cekSaldo()))
                else:
                    break
